...
uniform float u_detectionSize; // {"material":"ui_editor_properties_detection_size","default":1,"range":[0,5]}
...
void main() {
	...
	vec2 texelSize = vec2(1.0 / g_Texture0Resolution.z, 1.0 / g_Texture0Resolution.w) * u_detectionSize;
