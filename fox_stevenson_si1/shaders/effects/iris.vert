...
uniform float g_PhaseOffset; // {"material":"phase", "label":"ui_editor_properties_phase", "default":0,"range":[-5, 5]}
...
void main() {
	...
	vec2 da = mix(moveStart, moveEnd, smoothstep(1 - g_Rough, 1, frac(time)));
